...
def main(args):
    ...
    for video_name in im_list:
        ...
        np.savez_compressed(out_name, boxes=np.array(boxes, dtype=object), segments=np.array(segments, dtype=object), keypoints=np.array(keypoints, dtype=object), metadata=metadata)
